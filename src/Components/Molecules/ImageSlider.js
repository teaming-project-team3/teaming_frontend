export default function ImageSlider(props) {
  ...
  return (
    <div
      ...
      className="relative carousel slide h-[50vh]"
    ...
    >
      ...
      <div className="relative w-full overflow-hidden carousel-inner">
        <div className="relative float-left w-full carousel-item active">
          <img
            src={img1? img1 :"https://mdbootstrap.com/img/Photos/Slides/img%20(15).jpg"}
        ...
        <div className="relative float-left w-full carousel-item">
          <img
            src={img2? img2 :"https://mdbootstrap.com/img/Photos/Slides/img%20(15).jpg"}
            className="block w-full"
            alt="..."
          />
          <div className="absolute hidden text-center carousel-caption md:block">
        ...
        <div className="relative float-left w-full carousel-item">
          <img
            src={img3? img3 :"https://mdbootstrap.com/img/Photos/Slides/img%20(15).jpg"}
            className="block w-full"
            alt="..."
          />
          <div className="absolute hidden text-center carousel-caption md:block">
